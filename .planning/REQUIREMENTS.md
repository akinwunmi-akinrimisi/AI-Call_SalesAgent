...
- [x] **CALL-01**: Voice agent (Sarah) calls leads via Twilio from US number, powered by Gemini Live API with real-time audio streaming
...
- [x] **CALL-08**: Target call duration 5-10 minutes with duration watchdog triggering wrap-up at 8.5 minutes
...
| CALL-01 | Phase 3: Voice Agent Backend | Complete |
